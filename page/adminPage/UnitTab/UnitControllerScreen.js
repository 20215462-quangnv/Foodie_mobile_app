...
import { getAllUnit, createUnit, updateUnit, deleteUnit } from "../../../controller/measureUnitController";


const UnitControllerScreen = ({ navigation }) => {
    ...
    const handleDeleteItem = (itemId) => {
         deleteUnit(itemId)
            .then(() => {
               setUnits((prevItems) => prevItems.filter((item) => item.id !== itemId));
                setConfirmModalVisible(false);
                alert('Xóa đơn vị thành công thành công');
            })
            .catch((error) => {
              alert('Xoá đơn vị thất bại, thử lại');
    ...
    const handleSaveAddedItem = () => {
        ...
        createUnit(newItem)
            .then((createdItem) => {
                ...
                setUnits((prevItems) => [...prevItems, newItem]);
                setAddItemModalVisible(false);
                alert('Tạo đơn vị mới thành công:', newItem);
            })
            .catch((error) => {
              alert('Tạo đơn vị mới thất bại, thử lại');
     ...
     const handleSaveEditedItem = () => {
         const newItem = {
            ...
            unitName: editedItem.unitName,
            toGram: "",
            description: editedItem.description,
            
        };
        updateUnit(newItem, newItem.id)
            .then((createdItem) => {
                setUnits((prevItems) =>
                    prevItems.map((item) =>
                ...
                alert('Update đơn vị thành công:', newItem);
            })
            .catch((error) => {
              alert('Update đơn vị thất bại, thử lại');
          ...
          <View style = {styles.title}>
                        ...
                        <ScrollView style={styles.scrollViewListFood}>
                            <View style={styles.itemHolder}>
                                ...
                                {units.map((item, index) => (
                                    ...
                                    >
                                            <Text style={styles.itemName}>{item.unitName}:</Text>
            ...
            >
                    <View style={styles.modalBackground}>
                        ...
                        <Text style={styles.modalTitle}>Bạn muốn xóa đơn vị </Text>
                    ...
                    <View style={styles.modalBackground}>
                        ...
                        <Text style={styles.normalText}>Tên</Text>
                            <TextInput
                                ...
                                value = {editedItem.unitName}
                                onChangeText={(text) => setEditedItem({ ...editedItem, unitName: text })}
                    ...
                    <View style={styles.modalBackground}>
                        ...
                        <Text style={styles.normalText}>Tên</Text>
                            <TextInput
                                ...
                                onChangeText={(text) => setAddingItem({ ...addingItem, unitName: text })}
                                placeholder="Tên đơn vị"
                        />
                        <Text style={styles.normalText}>Mô tả</Text>
                            <TextInput
...
export default UnitControllerScreen