...
const StoreScreen = ({ navigation }) => {
  ...
  const handleShowChooseFood = () => {
    ...
    const handleChooseEditingItem = (food) => {
        setEditedItem({ ...editedItem, food: food })
    }
                        ...
                        {showDatePicker && (
                            <DateTimePickerModal
                                ...
                                onConfirm={(date) => {
                                    ...
                                    setEditedItem({ ...editedItem, expiredDate: isoDate });
                        ...
                        {showDatePicker && (
                            <DateTimePickerModal
                                ...
                                onConfirm={(date) => {
                                    ...
                                    setAddingItem({ ...addingItem, expiredDate: isoDate });
                                    console.log("Selected date in ISO 8601 format: " + isoDate);
                                    setShowDatePicker(false);
                                }}
                                onCancel={() => {
